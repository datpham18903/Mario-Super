...
public class Map {
	...
	public void updateLocations() {
		...
		for (Iterator<Prize> prizeIterator = revealedPrizes
				.iterator(); prizeIterator.hasNext();) {
			Prize prize = prizeIterator.next();
			if (prize instanceof Coin) {
				((Coin) prize).updateLocation();
				if (((Coin) prize).getRevealBoundary() > ((Coin) prize)
						.getY()) {
		...
		for (Iterator<Brick> brickIterator = revealedBricks
				.iterator(); brickIterator.hasNext();) {
